...
export default function DecisionRoom(){
 ...
 useEffect(()=>{let active=true;setValues(initial());restartSubmission();setCompliance('unresolved');setDemoGate(null);
 ...
 const exportSaved=(a:Assessment)=>download(`trendsell-assessment-${a.id}.json`,JSON.stringify({
   ...
   evidence:a.evidence??[], assessment:a},null,2));
