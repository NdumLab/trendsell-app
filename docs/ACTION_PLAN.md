...
| E01 source feasibility matrix | Ready | No provider access has been sought or granted. Researching permitted fields, rights, coverage, pricing and fallback does not require credentials and should precede any collector implementation; nothing is connected and nothing claims to be |
